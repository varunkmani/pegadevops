...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D4DFFE030D668D")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class PDF_P_ExtractCompany : OpenSpan.Automation.Automator
{
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D4DFFE030D668D\\EntryPoint-8D4E001511162B6")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	private OpenSpan.Automation.ExitPoint exitPoint1;
	
	public PDF_P_ExtractCompany()
	{
		// 
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(PDF_P_ExtractCompany));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE030D668D");
		// 
		// Set component Ids
		// 
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E0010BF5605E"));
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E0010BFC87C0"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E0010C015138"));
		this.SetId(this.connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E0010C06162B"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E0010C0ADB0F"));
		this.SetId(this.connectableTypeProxy1, new OpenSpan.Design.ComponentIdentity("ConnectableTypeProxy-8D4E0010C0FA037"));
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D4E001511162B6"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D4E001562738F1"));
		// 
		// PDF_P_ExtractCompany
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_1_");
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_2_");
		...
		this.Name = "PDF_P_ExtractCompany";
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_3_");
		...
		this.connectableMethod1.SerializedParamsDefaultValues = _resources_.GetString("_PDF_P_ExtractCompany_4_");
		// 
		// connectableMethod2
		// 
		...
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_5_");
		...
		memberprototype2.MemberName = "FindRelativeSegment";
		memberprototype2.MemberType = System.Reflection.MemberTypes.Method;
		parameterprototype2.CanRead = false;
		parameterprototype2.CanWrite = true;
		parameterprototype2.DefaultSet = true;
		parameterprototype2.DefaultValue = "Flat no. and building name:";
		parameterprototype2.ParamName = "searchFor";
		...
		parameterprototype3.ParamName = "occurrence";
		...
		parameterprototype4.DefaultValue = "1";
		parameterprototype4.ParamName = "relativeSegmentOffset";
		...
		parameterprototype5.ParamName = "segment";
		parameterprototype5.Position = 3;
		parameterprototype5.TypeAssemblyName = "OpenSpan.Pdf.PdfConnector";
		parameterprototype5.TypeName = "OpenSpan.Pdf.PdfConnector.PdfSegment";
		...
		this.connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E001DA628E");
		...
		this.connectableTypeProxy1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E001DA628E");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_6_");
		this.entryPoint1.DynamicMembers.Add(dynamicpropertyinfo3);
		this.entryPoint1.ExceptionsHandled = false;
		this.entryPoint1.InstanceTypeName = "OpenSpan.Automation.EntryPoint";
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE030D668D\\EntryPoint-8D4E001511162B6");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_7_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE030D668D\\EntryPoint-8D4E001511162B6");
		// 
		// Initialize CodeDom data
		// 
		this.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_8_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E0010BF5605E"));
		...
		connectableMethod1.SerializedParamsDefaultValues = _resources_.GetString("_PDF_P_ExtractCompany_4_");
		// 
		// Result
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E0010BFC87C0"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_5_");
		...
		parameterprototype1.DefaultValue = "Flat no. and building name:";
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E0010C015138"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E0010C06162B"));
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E0010C0ADB0F"));
		...
		connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E001DA628E");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableTypeProxy Create_connectableTypeProxy1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableTypeProxy1, new OpenSpan.Design.ComponentIdentity("ConnectableTypeProxy-8D4E0010C0FA037"));
		...
		connectableTypeProxy1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E001DA628E");
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D4E001511162B6"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_6_");
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D4E001562738F1"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_7_");
		...
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_PDF_P_ExtractCompany_6_");
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE030D668D\\EntryPoint-8D4E001511162B6");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D4E001511162B6"));
