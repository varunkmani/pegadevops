...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D4DFFE4FFCE97D")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class PDF_P_ExtractFax : OpenSpan.Automation.Automator
{
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D4DFFE4FFCE97D\\StringExpression-8D4E001B9224EFA")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D4DFFE4FFCE97D\\EntryPoint-8D4E001F9918907")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	private OpenSpan.Automation.ExitPoint exitPoint1;
	
	public PDF_P_ExtractFax()
	{
		// 
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(PDF_P_ExtractFax));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE4FFCE97D");
		// 
		// Set component Ids
		// 
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183A5FC92"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E00183AD239C"));
		this.SetId(this.connectableTypeProxy1, new OpenSpan.Design.ComponentIdentity("ConnectableTypeProxy-8D4E00183B1E880"));
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183B6AD64"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E00183BDD4C6"));
		this.SetId(this.connectableTypeProxy2, new OpenSpan.Design.ComponentIdentity("ConnectableTypeProxy-8D4E00183C299B9"));
		this.SetId(this.connectableMethod4, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183CC2386"));
		this.SetId(this.connectableMethod5, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183D0E8A4"));
		this.SetId(this.connectableMethod6, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183D5AD83"));
		this.SetId(this.connectableProperties3, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E00183DCD4B9"));
		this.SetId(this.stringExpression1, new OpenSpan.Design.ComponentIdentity("StringExpression-8D4E001B9224EFA"));
		this.SetId(this.connectableMethod7, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E001B9330029"));
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D4E001F9918907"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D4E0020D366641"));
		// 
		// PDF_P_ExtractFax
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_1_");
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_2_");
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_3_");
		...
		parameterprototype1.DefaultValue = "Telephone: (Res) _";
		...
		this.connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E1642972D7");
		...
		this.connectableTypeProxy1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E1642972D7");
		this.connectableTypeProxy1.ProxiedTypeName = "OpenSpan.Pdf.PdfConnector.PdfSegment";
		// 
		// connectableMethod2
		// 
		this.connectableMethod2.DisplayName = "<FindRelativeSegment>";
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_3_");
		...
		this.connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D4A78D69146BD3\\PdfConnector-8D4A831DECE5FA2");
		memberprototype3.DefaultValue = null;
		memberprototype3.MemberName = "FindRelativeSegment";
		memberprototype3.MemberType = System.Reflection.MemberTypes.Method;
		parameterprototype5.CanRead = false;
		parameterprototype5.CanWrite = true;
		parameterprototype5.DefaultSet = true;
		parameterprototype5.DefaultValue = "Telephone: (Res) _";
		parameterprototype5.ParamName = "searchFor";
		...
		parameterprototype6.ParamName = "occurrence";
		...
		parameterprototype7.DefaultValue = "3";
		parameterprototype7.ParamName = "relativeSegmentOffset";
		...
		parameterprototype8.ParamName = "segment";
		parameterprototype8.Position = 3;
		parameterprototype8.TypeAssemblyName = "OpenSpan.Pdf.PdfConnector";
		parameterprototype8.TypeName = "OpenSpan.Pdf.PdfConnector.PdfSegment";
		...
		this.connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E18EB4C4DB");
		...
		this.connectableTypeProxy2.InstanceTypeName = "OpenSpan.Pdf.PdfConnector.PdfSegment";
		this.connectableTypeProxy2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E18EB4C4DB");
		this.connectableTypeProxy2.ProxiedTypeName = "OpenSpan.Pdf.PdfConnector.PdfSegment";
		// 
		// connectableMethod4
		// 
		...
		this.connectableMethod4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A902E3A3CCEB");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_4_");
		...
		this.connectableMethod5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\StringUtils-8D4A8EB652459FB");
		...
		this.connectableMethod5.SerializedParamsDefaultValues = _resources_.GetString("_PDF_P_ExtractFax_5_");
		// 
		// connectableMethod6
		// 
		this.connectableMethod6.DisplayName = "<SetCellValue>";
		this.connectableMethod6.ExceptionsHandled = false;
		this.connectableMethod6.InstanceTypeName = "OpenSpan.Office.MicrosoftExcel";
		this.connectableMethod6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D4A78D69146BD3\\MicrosoftExcel-8D4A8E76E540409");
		...
		parameterprototype12.DefaultValue = "cell";
		parameterprototype12.ParamName = "cell";
		...
		parameterprototype13.ParamName = "cellValue";
		...
		dynamicmethodinfo2.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_6_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_4_");
		this.connectableMethod7.DynamicMembers.Add(dynamicpropertyinfo4);
		this.connectableMethod7.ExceptionsHandled = false;
		this.connectableMethod7.InstanceTypeName = "OpenSpan.Script.Expression.StringExpression";
		this.connectableMethod7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE4FFCE97D\\StringExpression-8D4E001B9224EFA");
		memberprototype9.DefaultValue = null;
		memberprototype9.MemberName = "Evaluate";
		...
		parameterprototype15.ParamName = "B";
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_7_");
		this.entryPoint1.DynamicMembers.Add(dynamicpropertyinfo5);
		this.entryPoint1.ExceptionsHandled = false;
		this.entryPoint1.InstanceTypeName = "OpenSpan.Automation.EntryPoint";
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE4FFCE97D\\EntryPoint-8D4E001F9918907");
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_8_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE4FFCE97D\\EntryPoint-8D4E001F9918907");
		// 
		// Initialize CodeDom data
		// 
		this.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_9_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183A5FC92"));
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E00183AD239C"));
		connectableProperties1.DefaultValues = "";
		connectableProperties1.DisplayName = "Properties";
		connectableProperties1.ExceptionsHandled = false;
		connectableProperties1.InstanceTypeName = "OpenSpan.Pdf.PdfConnector.PdfSegment";
		connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E1642972D7");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableTypeProxy Create_connectableTypeProxy1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableTypeProxy1, new OpenSpan.Design.ComponentIdentity("ConnectableTypeProxy-8D4E00183B1E880"));
		...
		connectableTypeProxy1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E1642972D7");
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183B6AD64"));
		connectableMethod2.DisplayName = "<FindRelativeSegment>";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D4A78D69146BD3\\PdfConnector-8D4A831DECE5FA2");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "FindRelativeSegment";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E00183BDD4C6"));
		...
		connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E18EB4C4DB");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Text";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableTypeProxy Create_connectableTypeProxy2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableTypeProxy2, new OpenSpan.Design.ComponentIdentity("ConnectableTypeProxy-8D4E00183C299B9"));
		connectableTypeProxy2.DisplayName = "Proxy";
		connectableTypeProxy2.ExceptionsHandled = false;
		connectableTypeProxy2.InstanceTypeName = "OpenSpan.Pdf.PdfConnector.PdfSegment";
		connectableTypeProxy2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\TypeProxy-8D4A8E18EB4C4DB");
		connectableTypeProxy2.ProxiedTypeName = "OpenSpan.Pdf.PdfConnector.PdfSegment";
		// 
		// Result
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod4, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183CC2386"));
		...
		connectableMethod4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A902E3A3CCEB");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod5(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod5, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183D0E8A4"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_4_");
		...
		connectableMethod5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4A831F356B715\\StringUtils-8D4A8EB652459FB");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		...
		connectableMethod5.SerializedParamsDefaultValues = _resources_.GetString("_PDF_P_ExtractFax_5_");
		// 
		// Result
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod6(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod6, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E00183D5AD83"));
		connectableMethod6.DisplayName = "<SetCellValue>";
		connectableMethod6.ExceptionsHandled = false;
		connectableMethod6.InstanceTypeName = "OpenSpan.Office.MicrosoftExcel";
		connectableMethod6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D4A78D69146BD3\\MicrosoftExcel-8D4A8E76E540409");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties3, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D4E00183DCD4B9"));
	...
	internal OpenSpan.Script.Expression.StringExpression Create_stringExpression1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(stringExpression1, new OpenSpan.Design.ComponentIdentity("StringExpression-8D4E001B9224EFA"));
		this.SetScope(stringExpression1, OpenSpan.Design.ConnectableScope.Local);
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_6_");
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod7(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod7, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D4E001B9330029"));
		...
		connectableMethod7.InstanceTypeName = "OpenSpan.Script.Expression.StringExpression";
		connectableMethod7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE4FFCE97D\\StringExpression-8D4E001B9224EFA");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D4E001F9918907"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_7_");
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D4E0020D366641"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_8_");
		...
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_PDF_P_ExtractFax_7_");
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D4DFFE4FFCE97D\\EntryPoint-8D4E001F9918907");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D4E001F9918907"));
